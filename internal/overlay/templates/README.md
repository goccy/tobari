...
If a required package is not in the dependency graph, a fundamental design change is needed (e.g., ensuring that the required package is already a transitive dependency of the target package).
